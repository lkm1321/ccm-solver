...
w11 = YalmipPolynomial([x1, x2], 1, 0);
w12 = YalmipPolynomial([x1, x2], 1, 0); 
w22 = YalmipPolynomial([x1, x2], 1, 0); 
...
LMI2 = (A*W + W*A' - B*differential*W - W*differential'*B' + 2*freeLambda*W );
