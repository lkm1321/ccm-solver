function xdot = MGobserverModel(~, x, openloopctrl)
    ...
    xhatdot = MGopenloop(0, x(1:2), openloopctrl) + feedBackTop + feedBackBottom; 
    xtruedot = MGopenloop(0, x(3:4), openloopctrl); 
